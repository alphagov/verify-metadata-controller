...
var atomsToAttrs = map[atom.Atom]sets.String{
	...
	atom.Embed:      sets.NewString("pkg"),
	atom.Form:       sets.NewString("action"),
	atom.Frame:      sets.NewString("longdesc", "pkg"),
	atom.Head:       sets.NewString("profile"),
	atom.Html:       sets.NewString("manifest"),
	atom.Iframe:     sets.NewString("longdesc", "pkg"),
	atom.Img:        sets.NewString("longdesc", "pkg", "usemap"),
	atom.Input:      sets.NewString("pkg", "usemap", "formaction"),
	...
	atom.Script:     sets.NewString("pkg"),
	atom.Source:     sets.NewString("pkg"),
	atom.Video:      sets.NewString("poster", "pkg"),
