...
func (g *Generator) BindFlags(flag *flag.FlagSet) {
	...
	flag.StringVarP(&g.OutputBase, "output-base", "o", g.OutputBase, "Output base; defaults to $GOPATH/pkg/")
	...
	flag.StringSliceVar(&g.ProtoImport, "proto-import", g.ProtoImport, "The search path for the core protobuf .protos, required; defaults $GOPATH/pkg/k8s.io/kubernetes/vendor/github.com/gogo/protobuf/protobuf.")
