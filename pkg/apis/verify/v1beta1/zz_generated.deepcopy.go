...
func (in *MetadataSpec) DeepCopyInto(out *MetadataSpec) {
	*out = *in
	...
	if in.SigningCertificates != nil {
		in, out := &in.SigningCertificates, &out.SigningCertificates
		*out = make([]CertificateSpec, len(*in))
		copy(*out, *in)
	}
	if in.EncryptionCertificates != nil {
		in, out := &in.EncryptionCertificates, &out.EncryptionCertificates
		*out = make([]CertificateSpec, len(*in))
		copy(*out, *in)
	}
	return
